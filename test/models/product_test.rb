...
class ProductTest < ActiveSupport::TestCase
  ...
  test "product price must be positive" do
    ...
    product.image.attach(io: File.open("test/fixtures/files/mango.jpg"),
    filename: "lorem.jpg", content_type: "mango/jpeg")
  ...
  test "image url" do
    product = new_product("apples.jpg", "image/jpeg")
  ...
  test "product is not valid without a unique title" do
    product = Product.new(title: products(:fruitveg).title,
    description: "yyy",
    price: 1)
    product.image.attach(io: File.open("test/fixtures/files/mango.jpg"),
    filename: "mango.jpg", content_type: "image/jpeg")
    assert product.invalid?
